...
do
    ...
    case $opt in
        ...
        "[log] Show read_only")
            ...
            ;;
        "[test][mukka] sysbench prepare")
            cmd="sysbench --report-interval=5 --threads=4 --num-requests=0 --time=20 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app1 --mysql-password=app1 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port prepare"
            exec_cmd "$cmd"
            break
            ;;
        "[test][mukka] sysbench run - 15 sec, ro")
            cmd="sysbench --report-interval=1 --threads=4 --num-requests=0 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app1 --mysql-password=app1 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port --oltp-read-only=on --mysql-ignore-errors=all --time=15 run"
            exec_cmd "$cmd"
            break
            ;;
        "[test][mukka] sysbench run - 60 sec, ro")
            cmd="sysbench --report-interval=1 --threads=4 --num-requests=0 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app1 --mysql-password=app1 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port --oltp-read-only=on --mysql-ignore-errors=all --time=60 run"
            exec_cmd "$cmd"
            break
            ;;
        ...
        "[test][mukka] Create 'world' sample db")
            ...
            ;;
        "[test][rol] sysbench prepare")
            cmd="sysbench --report-interval=5 --threads=4 --num-requests=0 --time=20 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app3 --mysql-password=app3 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port prepare"
            exec_cmd "$cmd"
            break
            ;;
        "[test][rol] sysbench run - 15 sec, ro")
            cmd="sysbench --report-interval=1 --threads=4 --num-requests=0 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app3 --mysql-password=app3 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port --oltp-read-only=on --mysql-ignore-errors=all --time=15 run"
            exec_cmd "$cmd"
            break
            ;;
        "[test][rol] sysbench run - 60 sec, ro")
            cmd="sysbench --report-interval=1 --threads=4 --num-requests=0 /usr/share/sysbench/tests/include/oltp_legacy/oltp.lua --mysql-user=app3 --mysql-password=app3 --oltp-table-size=10000 --mysql-host=$host --mysql-port=$app_port --oltp-read-only=on --mysql-ignore-errors=all --time=60 run"
            exec_cmd "$cmd"
            break
            ;;
